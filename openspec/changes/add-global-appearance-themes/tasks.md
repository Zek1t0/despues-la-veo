...
- [ ] 12.9 Perform a final structural search for palette-specific branches in screens, duplicate preview/CSS palettes, old theme imports, static color captures, any dependency/config change beyond the approved Expo SDK 54-compatible `expo-system-ui` integration, and modified browsing/TMDB/domain behavior.
